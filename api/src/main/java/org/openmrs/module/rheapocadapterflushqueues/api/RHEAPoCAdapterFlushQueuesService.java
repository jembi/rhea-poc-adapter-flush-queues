 ...
 */
package org.openmrs.module.rheapocadapterflushqueues.api;
 ...
 */
@Transactional
public interface RHEAPoCAdapterFlushQueuesService extends OpenmrsService {
     
	@Authorized({PrivilegeConstants.VIEW_ADMIN_FUNCTIONS})	
	FlushQueuesResult flushQueues();
}